      ...
      <div class="panel-body">
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-coupon">
          <div class="table-responsive">
			...
			<!-- kupon -->
                  <td class="text-left">
                    <?php $allcount = 0; foreach ($customer_groups as $customer_group) { ?>
                    <?php if (in_array($customer_group['customer_group_id'], $coupon['customer_group'])) { ?>
                    <?php echo $customer_group['name'];?> <br>
                    <?php $allcount++; } ?> 
                    <?php } ?> 
                    <?php if ($allcount == 0) { echo $entry_customer_group_all; } ?>
                  </td>
			<!-- kupon -->  
